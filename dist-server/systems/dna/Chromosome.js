...
exports.Chromosome = exports.MutationType = exports.Dominance = void 0;
// 显性类型
var Dominance;
(function (Dominance) {
    Dominance["FULL_DOMINANT"] = "full";
    Dominance["INCOMPLETE"] = "incomplete";
    Dominance["CODOMINANT"] = "codominant";
    Dominance["RECESSIVE"] = "recessive"; // 隐性
})(Dominance || (exports.Dominance = Dominance = {}));
// 突变类型
var MutationType;
(function (MutationType) {
    MutationType["POINT"] = "point";
    MutationType["INSERTION"] = "insertion";
    MutationType["DELETION"] = "deletion";
    MutationType["DUPLICATION"] = "duplication"; // 重复
...
class Chromosome {
    ...
    randomAllele() {
        const r = Math.random();
        if (r < 0.1)
            return Math.random() * 0.3; // 10% 低值
        if (r > 0.9)
            return 0.7 + Math.random() * 0.3; // 10% 高值
