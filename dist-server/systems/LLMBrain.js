...
exports.LLMBrain = void 0;
class LLMBrain {
    constructor() {
        this.ollamaUrl = 'http://localhost:11434';
        this.model = 'qwen3.5:2b';
        this.cooldown = new Map(); // 角色决策冷却
        this.cooldowMs = 5000; // 5秒决策一次
        // 可用动作列表
